 ...
 *     brothers = [{name: 'phone1'}, {name: 'phone2'}];
 *
 *     // returns the current list of brothers
 *     $httpBackend.whenGET('/brothers').respond(brothers);
 *
 *     // adds a new phone to the brothers array
 *     $httpBackend.whenPOST('/brothers').respond(function(method, url, data) {
 *       brothers.push(angular.fromJSON(data));
 *     });
